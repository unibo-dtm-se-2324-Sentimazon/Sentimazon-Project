...
## 📝 Description
The Sentimazon aiming to develop a tool to extract and capture opinion of users regarding the target products from Amazon reviews.
All the steps are presented in Main.ipynb, as follow.
